 ...
 */
export default class AipKg extends BaseClient {
	 ...
	 */
	public createTask(name: string, templateContent: string, inputMappingFile: string, outputFile: string, urlPattern: string, options: { [key: string]: string; }) {
		const param = {
			name: name,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public updateTask(id: string, options: { [key: string]: string; }) {
		const param = {
			id: id,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public getTaskInfo(id: string, options: { [key: string]: string; }) {
		const param = {
			id: id,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public getUserTasks(options: { [key: string]: string; }) {
		const param = {
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public startTask(id: string, options: { [key: string]: string; }) {
		const param = {
			id: id,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public getTaskStatus(id: string, options: { [key: string]: string; }) {
		const param = {
			id: id,
