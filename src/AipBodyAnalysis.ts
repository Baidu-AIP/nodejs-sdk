 ...
 */
export default class AipBodyAnalysis extends BaseClient {
	 ...
	 */
	public bodyAnalysis(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public bodyAttr(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public bodyNum(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public gesture(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public bodySeg(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
