...
export default class AipOcr extends BaseClient {
	 ...
	 */
	public generalBasic(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public generalBasicUrl(url: string, options: { [key: string]: string; }) {
		const param = {
			url: url,
			targetPath: GENERAL_BASIC_PATH
		};
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public accurateBasic(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public general(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public generalUrl(url: string, options: { [key: string]: string; }) {
		const param = {
			url: url,
			targetPath: GENERAL_PATH
		};
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public accurate(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public generalEnhance(image: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public custom(image: string, templateSign: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
