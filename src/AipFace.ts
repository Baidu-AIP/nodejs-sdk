...
export default class AipFace extends BaseClient {
	 ...
	 */
	public detect(image: string, imageType: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public search(image: string, imageType: string, groupIdList: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
			image_type: imageType,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public multiSearch(image: string, imageType: string, groupIdList: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
			image_type: imageType,
			group_id_list: groupIdList,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public addUser(image: string, imageType: string, groupId: string, userId: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
			image_type: imageType,
			group_id: groupId,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public updateUser(image: string, imageType: string, groupId: string, userId: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
			image_type: imageType,
			group_id: groupId,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public getGroupUsers(groupId: string, options: { [key: string]: string; }) {
		const param = {
			group_id: groupId,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public userCopy(userId: string, options: { [key: string]: string; }) {
		const param = {
			user_id: userId,
	 ...
	 * @return {Promise} - 标准Promise对象
	 */
	public personVerify(image: string, imageType: string, idCardNumber: string, name: string, options: { [key: string]: string; }) {
		const param = {
			image: image,
			image_type: imageType,
