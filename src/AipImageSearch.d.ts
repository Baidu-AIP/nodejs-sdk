...
declare class AipImageSearch extends BaseClient {
     ...
     */
    sameHqAdd(image: any, options: any): Promise<any>;
    /**
     * 相同图检索—检索接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    sameHqSearch(image: any, options: any): Promise<any>;
    /**
     * 相同图检索—删除接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    sameHqDeleteByImage(image: any, options: any): Promise<any>;
    /**
     * 相同图检索—删除接口
     *
     ...
     * @return {Promise} - 标准Promise对象
     */
    sameHqDeleteBySign(contSign: any, options: any): Promise<any>;
    /**
     * 相似图检索—入库接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    similarAdd(image: any, options: any): Promise<any>;
    /**
     * 相似图检索—检索接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    similarSearch(image: any, options: any): Promise<any>;
    /**
     * 相似图检索—删除接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    similarDeleteByImage(image: any, options: any): Promise<any>;
    /**
     * 相似图检索—删除接口
     *
     * @param {string} contSign - 图片签名（和image二选一，image优先级更高）
     ...
     * @return {Promise} - 标准Promise对象
     */
    similarDeleteBySign(contSign: any, options: any): Promise<any>;
    /**
     * 商品检索—入库接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    productAdd(image: any, options: any): Promise<any>;
    /**
     * 商品检索—检索接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    productSearch(image: any, options: any): Promise<any>;
    /**
     * 商品检索—删除接口
     *
     * @param {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     ...
     * @return {Promise} - 标准Promise对象
     */
    productDeleteByImage(image: any, options: any): Promise<any>;
    /**
     * 商品检索—删除接口
     *
     * @param {string} contSign - 图片签名（和image二选一，image优先级更高）
     ...
     * @return {Promise} - 标准Promise对象
     */
    productDeleteBySign(contSign: any, options: any): Promise<any>;
}
